...
# randompasswordgenerator-GreatStack 

This project is a Random Password Generator app built using HTML,CSS and JAVASCRIPT. This project is originally created by a SoftWare Developer known as GreatStack(Avinash). I followed his tutorial to better understand how to work with APIs and build interactive web apps. Here is the tutorial I used from GreatStack to make these projects:
  ➡️ https://youtube.com/playlist?list=PLjwm_8O3suyOgDS_Z8AWbbq3zpCmR-WE9&si=VN2mtni3oKeM6M2h


 This app will generate a strong password that includes uppercase letters, lowercase letters, numbers, and symbols. Additionally, there is a password copy button, allowing you to easily copy the newly generated password.
