...
In this app, each time someone visits the site, it will display a new quote automatically. The site will also include a button to generate a new quote on demand, as well as a button to share the quote directly on Twitter.
