...
# backgroundeffect-GreatStack 

This project is a form validation app built using HTML,CSS and JAVASCRIPT. This project is originally created by a SoftWare Developer known as GreatStack(Avinash). I followed his tutorial to better understand how to work with APIs and build interactive web apps. Here is the tutorial I used from GreatStack to make these projects:
  ➡️ https://youtube.com/playlist?list=PLjwm_8O3suyOgDS_Z8AWbbq3zpCmR-WE9&si=VN2mtni3oKeM6M2h


In this website, there's an image that reveals a transparent or original background as you move your cursor left or right over it. A vertical line with an arrow icon separates the two versions of the image, allowing you to visually compare them in real-time.
